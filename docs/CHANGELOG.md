...
- Fixed: Screenscraper.fr authentication failure, when [user
  password](CONFIGINI.md#usercreds) contains a colon or other special
  characters, thanks @saitamasahil
